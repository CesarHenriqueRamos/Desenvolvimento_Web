<section class="banner-container" >	
	<div class="overlay"></div><!--overlay-->
		<div class="center">
		<form method="post">
			<h2><label for="email">Qual o seu melhor e-mail?</label></h2>
    ...
    <div class="container">
            <h1 class="title">Tecnologias Usadas</h1>
            ...
            <div class="box-especialidade">
                <h2>PHP</h2>
                <h3><i class="fab fa-php" style="color:#7478AE;"></i></h3>
            </div>
            </div><!--w33-->
            <div class="w33 especialidade-single">  
            <div class="box-especialidade">              
                <h2>JAVA</h2>
                <h3><i class="fab fa-java" style="color:#DE4B33;"></i></h3>
            </div>
            </div><!--w33-->
            <div class="w33 especialidade-single">  
                <div class="box-especialidade">
                    <h2>MySql</h2>
                    <h3><i class="fas fa-database" style="color:#BEBEBE;"></i></h3>
                </div>             
            </div><!--w33-->
            </div>
            <div class="slider-sigle1">
            ...
            <div class="w33 especialidade-single">  
                <div class="box-especialidade">
                    <h2>React Native</h2>
                    <h3><i class="fab fa-react" style="color:#7478AE;"></i></h3>
                </div>             
            </div><!--w33-->
            </div> 
            <!--<div class="bullets1">-->
